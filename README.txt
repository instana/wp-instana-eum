...
This plugin provides an easy way to insert the Instana End User Monitoring beacon to your Wordpress site.

== Description ==
This Wordpress plugin allows you to easily add the Instana Web EUM Tracing Beacon to any Wordpress installation. The plugin will insert the required JavaScript snippet into the head section of your pages.
